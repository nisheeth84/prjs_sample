...
export interface IAnalysisControlSidebarProps extends StateProps, DispatchProps {
...
const AnalysisControlSidebar = (props: IAnalysisControlSidebarProps) => {
  ...
  const onOpenMyGroupModal = (myGroupModalMode, currentGroupId, isAutoGroup) => {
    ...
    props.toggleOpenAddEditMyGroupModal(myGroupModalMode, isAutoGroup);
  }
                    ...
                    <ul className="list-group group">
                      <li className="category">
                        ...
                        <div className="d-flex">
                          ...
                          <span className="plus-blue" onClick={null} />
                        </div>
