...
import jp.co.softbrain.esales.uaa.domain.AbstractAuditingEntity;
import jp.co.softbrain.esales.uaa.repository.EmpAuthorityRepository;
import jp.co.softbrain.esales.uaa.service.AuthorityService;
import jp.co.softbrain.esales.uaa.tenant.util.TenantUtil;
...
@ComponentScan(basePackages = { "jp.co.softbrain.esales.uaa.repository",
        "jp.co.softbrain.esales.uaa.domain"})
@EnableJpaRepositories(basePackages = {
        "jp.co.softbrain.esales.uaa.repository",
        "jp.co.softbrain.esales.uaa.service" },
...
public class TenantDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(AbstractAuditingEntity.class.getPackage().getName(),
                EmpAuthorityRepository.class.getPackage().getName(), AuthorityService.class.getPackage().getName());

        emfBean.setJpaVendorAdapter(jpaVendorAdapter());

        emfBean.setPersistenceUnitName(ConstantsUaa.SERVICE_NAME + "-" + tenantDatabaseConfigProperties.getPoolName());
