...
import jp.co.softbrain.esales.customers.config.oauth2.CognitoProperties;
import jp.co.softbrain.esales.customers.config.oauth2.OAuth2JwtAccessTokenConverter;
