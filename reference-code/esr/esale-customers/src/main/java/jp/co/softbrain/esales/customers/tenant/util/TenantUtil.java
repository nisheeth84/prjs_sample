...
import jp.co.softbrain.esales.customers.tenant.client.config.TenantDatabaseConfigProperties;
...
public class TenantUtil {
    ...
    public static Properties hibernateProperties(Environment env) {
        ...
        properties.put(org.hibernate.cfg.Environment.SHOW_SQL, isShowSql);
        properties.put(org.hibernate.cfg.Environment.FORMAT_SQL, isShowSql);
    ...
    public static HikariDataSource getTenantDataSource(TenantDatabaseConfigProperties tenantDatabaseConfigProperties,
        ...
        ds.setPoolName(ConstantsCustomers.SERVICE_NAME + "-" + dbtype + "-"
