...
import jp.co.softbrain.esales.customers.config.DbType;
import jp.co.softbrain.esales.customers.domain.AbstractAuditingEntity;
import jp.co.softbrain.esales.customers.tenant.util.TenantUtil;
...
@ComponentScan(basePackages = { "jp.co.softbrain.esales.customers.repository",
		"jp.co.softbrain.esales.customers.domain" })
@EnableJpaRepositories(basePackages = { "jp.co.softbrain.esales.customers.repository",
		"jp.co.softbrain.esales.customers.service" }, entityManagerFactoryRef = "tenantEntityManagerFactory", transactionManagerRef = "tenantTransactionManager")
public class TenantDatabaseConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(AbstractAuditingEntity.class.getPackage().getName(),
                "jp.co.softbrain.esales.customers.repository",
                "jp.co.softbrain.esales.customers.service");

		emfBean.setJpaVendorAdapter(jpaVendorAdapter());

		emfBean.setPersistenceUnitName(
				ConstantsCustomers.SERVICE_NAME + "-" + tenantDatabaseConfigProperties.getPoolName());
