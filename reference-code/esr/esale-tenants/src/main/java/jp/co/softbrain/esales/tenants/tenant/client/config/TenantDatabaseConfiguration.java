...
import jp.co.softbrain.esales.tenants.domain.AbstractAuditingEntity;
...
@ComponentScan(basePackages = { "jp.co.softbrain.esales.tenants.repository",
        "jp.co.softbrain.esales.tenants.domain"})
@EnableJpaRepositories(basePackages = {
        "jp.co.softbrain.esales.tenants.repository",
        "jp.co.softbrain.esales.tenants.service" },
...
public class TenantDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPersistenceUnitName(
                ConstantsTenants.SERVICE_NAME + "-" + tenantDatabaseConfigProperties.getPoolName());
