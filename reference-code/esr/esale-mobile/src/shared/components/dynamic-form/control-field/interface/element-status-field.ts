...
export interface IElementStatusField {
  ...
  formatDate?: string | any;// only control date
  statusDayBeforeAfter?:boolean;// only control date
  statusDayTodayBefore?:boolean;// only control date
  statusDayTodayAfter?:boolean;// only control date
}
