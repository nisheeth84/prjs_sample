...
import { updateFieldInfoPersonals } from '../../../repository/trading-product-suggest-repositoty';
...
export function SearchDetailModal(props: ISearchDetailModalProps) {
   ...
   * @param dataSelected 
   */
  const handleUpdateFieldInfoPersonals = async (dataSelected: IFieldInfoPersonal[]) => {
    await updateFieldInfoPersonals({
      fieldBelong: 14,
      extensionBelong: 2,
      fieldInfos: dataSelected
    });
  }
