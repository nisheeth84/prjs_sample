DROP FOREIGN TABLE IF EXISTS "field_info_view" CASCADE;
...
DROP FOREIGN TABLE IF EXISTS "field_info_personal_view" CASCADE;
...
DROP FOREIGN TABLE IF EXISTS "field_info_item_view" CASCADE;
...
DROP FOREIGN TABLE IF EXISTS "languages_view" CASCADE;
