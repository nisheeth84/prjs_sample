...
import jp.co.softbrain.esales.employees.domain.AbstractAuditingEntity;
...
import jp.co.softbrain.esales.employees.tenant.util.TenantUtil;
...
@ComponentScan(basePackages = { "jp.co.softbrain.esales.employees.repository",
        "jp.co.softbrain.esales.employees.domain" })
@EnableJpaRepositories(basePackages = { "jp.co.softbrain.esales.employees.repository",
        "jp.co.softbrain.esales.employees.service" },
...
public class TenantDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(AbstractAuditingEntity.class.getPackage().getName(),
                EmployeesRepository.class.getPackage().getName(), EmployeesService.class.getPackage().getName());

        emfBean.setJpaVendorAdapter(jpaVendorAdapter());

        emfBean.setPersistenceUnitName(
                ConstantsEmployees.SERVICE_NAME + "-" + tenantDatabaseConfigProperties.getPoolName());
