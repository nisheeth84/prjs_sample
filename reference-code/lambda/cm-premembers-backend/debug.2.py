...
from premembers.repository.const import TaskTypeCode
...
class TestOrganization(unittest.TestCase):
    ...
    def test_delete_organizations_success(self):
        ...
        for organizationTask in organizationTasks:
            if (organizationTask['Code'] == TaskTypeCode.DeleteOrgUser):
                self.assertEqual(
...
try:
    ...
    TestOrganization().test_delete_organizations_success()
finally:
