...
from premembers.organizations.batch import organizations
...
class TestOrganizations(unittest.TestCase):
    ...
    def test_batch_delete_organization_error_status_task(self):
        # Status = 1 Running
        event_mock = {
    ...
    def test_batch_delete_organization_error_get_projects(self):
        event_mock = {
            'TaskId': task_id.format(str(7)),
            'Message': {
                'MessageId': 'MessageId',
                'ReceiptHandle': 'ReceiptHandle'
            }
        ...
        # Get data in database
        organization_task = pm_organizationTasks.query_key(
            task_id.format(str(7)))
        # Check data
        self.assertEqual(organization_task['TaskStatus'], Status.Done.value)

    def test_batch_delete_organization_error_get_awscoops(self):
        event_mock = {
