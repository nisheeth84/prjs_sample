...
check_item_code = "CHECK_CIS12_ITEM_4_02"
...
@mock_sts
@mock_s3
class TestCheckCisItem402(TestCaseBase):
    def setUp(self):
        super().setUp()
        global session
        ...
        # create record query
        # create resource for check code item 4.02
    ...
    def test_check_cis_item_4_02_exclusion_resource_success(self):
        # mock object
        ...
        # call Function test
        actual_response = cis_item_4_logic.check_cis_item_4_02(
    ...
    def test_check_cis_item_4_02_exclusion_resource_error_check_resource(self):
        # mock object
        patch_get_regions = patch("premembers.common.aws_common.get_regions")
        patch_describe_security_groups = patch("premembers.common.Ec2Utils.describe_security_groups")
        patch_upload_json = patch("premembers.common.FileUtils.upload_json")
        ...
        with patch.object(
            ...
            with self.assertRaises(Exception):
                # call Function test
                cis_item_4_logic.check_cis_item_4_02(
                    trace_id, check_history_id, organization_id, project_id,
                    aws_account, session, result_json_path, check_item_code,
                    excluded_resources)
