...
check_item_code = "CHECK_CIS12_ITEM_1_02"
result_json_path = copy.deepcopy(CommonConst.PATH_CHECK_RESULT).format(
...
@mock_dynamodb2
@mock_sts
class TestCheckCisItem102(TestCaseBase):
    def setUp(self):
        super().setUp()
        global session
        ...
        # create record query
        # create resource for check code item 1.02
    ...
    def test_check_cis_item_1_02_exclusion_resource_success(self):
        # mock object
        ...
        # mock data
        mock_get_credential_report.return_value = "user,arn,user_creation_time,password_enabled,password_last_used,password_last_changed,password_next_rotation,mfa_active,access_key_1_active,access_key_1_last_rotated,access_key_1_last_used_date,access_key_1_last_used_region,access_key_1_last_used_service,access_key_2_active,access_key_2_last_rotated,access_key_2_last_used_date,access_key_2_last_used_region,access_key_2_last_used_service,cert_1_active,cert_1_last_rotated,cert_2_active,cert_2_last_rotated\n<root_account>,arn:aws:iam::964503621683:root,2018-06-01T06:55:24+00:00,not_supported,2018-07-09T00:48:51+00:00,not_supported,not_supported,true,true,N/A,N/A,N/A,N/A,true,N/A,N/A,N/A,N/A,false,N/A,false,N/A\nCISv12-1_02,arn:aws:iam::964503621683:user/CISv12-1_02,2019-03-06T09:35:15+00:00,true,2019-03-07T06:39:12+00:00,2019-03-07T06:38:57+00:00,2019-06-05T06:38:57+00:00,true,true,2019-03-06T09:49:42+00:00,N/A,N/A,N/A,true,2019-03-06T10:10:38+00:00,N/A,N/A,N/A,false,N/A,false,N/A\nCISv12-ManualAssessment,arn:aws:iam::964503621683:user/CISv12-ManualAssessment,2019-03-18T02:40:41+00:00,true,2019-03-18T05:37:50+00:00,2019-03-18T02:40:42+00:00,2019-06-16T02:40:42+00:00,false,true,N/A,N/A,N/A,N/A,true,N/A,N/A,N/A,N/A,false,N/A,false,N/A\nserverless-user,arn:aws:iam::964503621683:user/serverless-user,2018-09-13T02:49:13+00:00,false,N/A,N/A,N/A,false,true,2018-09-13T02:49:33+00:00,N/A,ap-northeast-1,s3,true,N/A,N/A,N/A,N/A,false,N/A,false,N/A"
        mock_upload_json.return_value = None
        except_abnormality_users_result_check = ['CISv12-ManualAssessment']
        ...
        # call Function test
        actual_response = cis_item_1_logic.check_cis_item_1_02(
        ...
        actual_abnormality_users_result_check = actual_params_call_upload_json[
            2]['CheckResults'][0]['DetectionItem']['AbnormalityUsers']
        ...
        self.assertEqual(except_abnormality_users_result_check,
    ...
    def test_check_cis_item_1_02_exclusion_resource_error_check_resource(self):
        # mock object
        patch_get_credential_report = patch("premembers.check.logic.cis.cis_item_1_logic.get_credential_report")
        patch_upload_json = patch("premembers.common.FileUtils.upload_json")
        ...
        with patch.object(
            ...
            with self.assertRaises(Exception):
                cis_item_1_logic.check_cis_item_1_02(
                    trace_id, check_history_id, organization_id, project_id,
                    aws_account, session, result_json_path, check_item_code,
                    excluded_resources)
