...
check_item_code = "CHECK_CIS12_ITEM_1_21"
...
@mock_iam
@mock_s3
class TestCheckCisItem121(TestCaseBase):
    def setUp(self):
        super().setUp()
        global session
    ...
    def test_check_cis_item_1_21_exclusion_resource_success(self):
        # mock object
        patch_get_credential_report = patch(
            "premembers.check.logic.cis.cis_item_1_logic.get_credential_report"
        )
        ...
        except_abnormality_users_result_check = [
            'CISv12-1_02',
            'CISv12-ManualAssessment',
            'serverless-user'
        ]

        # call Function test
        actual_response = cis_item_1_logic.check_cis_item_1_21(
    ...
    def test_check_cis_item_1_21_exclusion_resource_error_check_resource(self):
        # mock object
        patch_get_credential_report = patch(
            "premembers.check.logic.cis.cis_item_1_logic.get_credential_report"
        )
        ...
        with patch.object(
            ...
            with self.assertRaises(Exception):
                cis_item_1_logic.check_cis_item_1_21(
                    trace_id, check_history_id, organization_id, project_id,
                    aws_account, session, result_json_path, check_item_code,
                    excluded_resources)
