...
check_item_code = "CHECK_CIS12_ITEM_1_04"
...
@mock_dynamodb2
@mock_sts
class TestCheckCisItem104(TestCaseBase):
    def setUp(self):
        super().setUp()
        global session
        ...
        # create record query
        # create resource for check code item 1.04
    ...
    def test_check_cis_item_1_04_exclusion_resource_success(self):
        # mock object
        ...
        expect_result_check = [{
            'DetectionItem': {
                'AcceseKeyRotatedAbnormity': True,
                'User': 'CISv12-1_04'
            },
            'Level': '21',
        ...
        # call Function test
        actual_response = cis_item_1_logic.check_cis_item_1_04(
    ...
    def test_check_cis_item_1_04_exclusion_resource_error_check_resource(self):
        # mock object
        patch_get_credential_report = patch("premembers.check.logic.cis.cis_item_1_logic.get_credential_report")
        patch_upload_json = patch("premembers.common.FileUtils.upload_json")
        ...
        with patch.object(
            ...
            with self.assertRaises(Exception):
                cis_item_1_logic.check_cis_item_1_04(
                    trace_id, check_history_id, organization_id, project_id,
                    aws_account, session, result_json_path, check_item_code,
                    excluded_resources)
