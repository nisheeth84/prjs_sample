...
bucket_acl = copy.deepcopy(DataTestS3.BUCKET_ACL)
...
@mock_sts
@mock_s3
class TestCheckCisItem203(TestCaseBase):
    def setUp(self):
        super().setUp()
        ...
        # create record query
        # create resource for check code item 2.03
    ...
    def test_check_cis_item_2_03_case_success(self):
        expected_check_results = [
            {
                'DetectionItem': {
                    'BucketName': 'S3BucketName',
                    'BucketPolicyAbnormity': True
                },
                'Level': '21',
                'Region': 'eu-north-1'
            }
        ...
        patch_get_bucket_acl = patch("premembers.common.S3Utils.get_bucket_acl")
        patch_get_bucket_policy = patch("premembers.common.S3Utils.get_bucket_policy")
        ...
        mock_get_bucket_acl = patch_get_bucket_acl.start()
        mock_get_bucket_policy = patch_get_bucket_policy.start()
        ...
        mock_get_bucket_acl.return_value = bucket_acl
        mock_get_bucket_policy.return_value = bucket_policy
        ...
        self.assertEqual(2, actual_result_check)
