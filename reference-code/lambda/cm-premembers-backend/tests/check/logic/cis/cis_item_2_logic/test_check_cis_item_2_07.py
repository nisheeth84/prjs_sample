...
@mock_dynamodb2
@mock_sts
class TestCheckCisItem207(TestCaseBase):
    def setUp(self):
        super().setUp()
        ...
        # create record query
        # create resource for check code item 2.07
    ...
    def test_check_cis_item_2_07_case_success(self):
        ...
        # call Function test
        actual_result_check = cis_item_2_logic.check_cis_item_2_07(
