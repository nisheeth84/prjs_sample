...
trails_status = copy.deepcopy(DataTestCloudTrail.TRAILS_STATUS)
...
@mock_dynamodb2
@mock_sts
class TestCheckCisItem204(TestCaseBase):
    def setUp(self):
        super().setUp()
        ...
        # create record query
        # create resource for check code item 2.04
    ...
    def test_check_cis_item_2_04_case_success(self):
        expected_check_results = [
            {
                'DetectionItem': {
                    'CloudTrailName': 'CloudTrailName',
                    'CloudTrailConfigAbnormity': True
                },
                'Level': '21',
                'Region': 'eu-north-1'
            }
        ...
        patch_get_trails_status = patch(
            "premembers.common.CloudTrailUtils.get_trails_status")
        ...
        mock_get_trails_status = patch_get_trails_status.start()
        ...
        mock_get_trails_status.return_value = trails_status
        ...
        self.addCleanup(patch_get_trails_status.stop)
        ...
        # call Function test
        actual_result_check = cis_item_2_logic.check_cis_item_2_04(
