...
class TestOrganization(unittest.TestCase):
    def setUp(self):
        ...
        organizationTasks = pm_organizationTasks.get_all_organizationTask(user_id_sign_in)
        for organizationTask in organizationTasks:
            pm_organizationTasks.delete(user_id_sign_in, organizationTask['TaskID'])
    ...
    def test_delete_user_susscess(self):
        ...
        target = CommonConst.TARGET_ORGANIZATION_TASK.format(
    ...
    def test_list_reports_susscess(self):
        dailycheck_logic.execute_check_job_launcher("dfs")
        # awschecksBatch_logic.send_result_email(
        #     "hainv", "e917de73-2f78-44db-8f3a-debdb1efe9e5")
        # awsResourceChecker_logic.aws_resource_checker("83354645-cf37-4ab0-8218-8c3577096ef0", "")
        # awsResourceAggregate_logic.aws_resource_aggregate("b3e8e710-49a8-422a-9f4c-e92799230bef", "")
        # awsResourceAggregate_logic.check_result_notification("2c1f9455-baec-4725-817a-6586f74c359f")
        # pm_assessmentItems.query_organization_index("111", "2222", "333")


# try:
#     TestOrganization().setUp()
#     TestOrganization().test_delete_user_delete_itself_susscess()
# finally:
#     TestOrganization().tearDown()


# TestReports().setUp()
TestOrganization().test_list_reports_susscess()
