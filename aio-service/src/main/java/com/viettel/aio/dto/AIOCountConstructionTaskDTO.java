...
public class AIOCountConstructionTaskDTO {
    ...
    public Long getChotiepnhan() {
        return chotiepnhan;
    }

    public void setChotiepnhan(Long chotiepnhan) {
        this.chotiepnhan = chotiepnhan;
    }

    public Long getDatiepnhan() {
        return datiepnhan;
    }

    public void setDatiepnhan(Long datiepnhan) {
        this.datiepnhan = datiepnhan;
    }

    public Long getDatuchoi() {
        return datuchoi;
    }

    public void setDatuchoi(Long datuchoi) {
