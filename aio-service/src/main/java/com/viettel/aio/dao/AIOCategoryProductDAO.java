...
@Transactional
@Repository("aioCategoryProductDAO")
public class AIOCategoryProductDAO extends BaseFWDAOImpl<AIOCategoryProductBO, Long> {

    public AIOCategoryProductDAO() {
        this.model = new AIOCategoryProductBO();
    }

    public AIOCategoryProductDAO(Session session) {
    ...
    public List<AIOCategoryProductDTO> doSearch(AIOCategoryProductDTO criteria) {
        StringBuilder sql = new StringBuilder("SELECT ")
                .append("acp.CATEGORY_PRODUCT_ID categoryProductId, ")
                .append("acp.CODE code, ")
                .append("acp.NAME name, ")
                .append("acp.CREATE_USER createUser, ")
                .append("su.FULL_NAME createUserName, ")
                .append("acp.CREATE_DATE createDate, ")
                .append("acp.STATUS status ")
                .append("FROM AIO_CATEGORY_PRODUCT acp INNER JOIN SYS_USER su ON su.SYS_USER_ID = acp.CREATE_USER WHERE 1=1 ");
    ...
    public List<AIOCategoryProductPriceDTO> getListPriceByCategoryProductId(Long id) {
        return this.getListPriceByCategoryProductId(Collections.singletonList(id));
    }

    public List<AIOCategoryProductPriceDTO> getListPriceByCategoryProductId(List<Long> ids) {
        StringBuilder sql = new StringBuilder("SELECT ")
                .append("AIO_CATEGORY_PRODUCT_PRICE_ID aioCategoryProductPriceId, ")
                .append("AIO_CATEGORY_PRODUCT_ID aioCategoryProductId, ")
                .append("TYPE type, ")
                .append("VALUE_TO valueTo, ")
                .append("VALUE_FROM valueFrom ")
                .append("FROM AIO_CATEGORY_PRODUCT_PRICE ")
                .append("where AIO_CATEGORY_PRODUCT_ID in (:ids) ");
    ...
    public void deleteCategoryProductDetail(Long id) {
        StringBuilder sql = new StringBuilder("DELETE FROM AIO_CATEGORY_PRODUCT_PRICE where AIO_CATEGORY_PRODUCT_ID=:id");
    ...
    public List<AIOCategoryProductDTO> getAutoCompleteData(AIOCategoryProductDTO dto) {
        StringBuilder sql = new StringBuilder("SELECT CODE code,NAME name " +
                "FROM AIO_CATEGORY_PRODUCT WHERE  1=1 ");
        ...
        sql.append(" order by CATEGORY_PRODUCT_ID asc ");
