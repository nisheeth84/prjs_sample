    ...
    public class CatPartnerDAO extends BaseFWDAOImpl<CatPartnerBO, Long> {
        ...
        public List<CatPartnerDTO> doSearch(CatPartnerDTO criteria) {
            ...
            stringBuilder.append("FROM CTCT_CAT_OWNER.CAT_PARTNER T1 where T1.STATUS=1 ");
    ...
    //		}
        ...
        public CatPartnerDTO getById(Long id) {
          ...
          public List<CatPartnerDTO> getAllCode(){
                StringBuilder sql = new StringBuilder("Select CAT_PARTNER_ID catPartnerId, "
                        + "CODE code"
                        + " FROM CTCT_CAT_OWNER.CAT_PARTNER "
                        + " where STATUS != 0");
