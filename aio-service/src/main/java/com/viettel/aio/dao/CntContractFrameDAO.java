 ...
 * @author hnx
 */
@Repository("cntContractFrameDAO")
public class CntContractFrameDAO extends BaseFWDAOImpl<CntContractBO, Long> {

    public CntContractFrameDAO() {
        this.model = new CntContractBO();
    }

    public CntContractFrameDAO(Session session) {
...
//
//		stringBuilder.append(" AND T1.CONTRACT_TYPE = 5");
//
...
//
	public StringBuilder getSelectAllQuery(){
		...
		stringBuilder.append(",(SELECT T6.NAME FROM CNT_CONTRACT T6 WHERE T6.CNT_CONTRACT_ID = T1.CNT_CONTRACT_PARENT_ID) cntContractParentName ");
//		stringBuilder.append(",case when (T1.END_TIME <= sysdate AND T1.STATUS != 4) then 'Đúng tiến độ' else 'Chậm tiến độ' end state ");
    	stringBuilder.append("FROM CNT_CONTRACT T1 ");
...
//		stringBuilder.append(",T1.UPDATED_USER_ID updatedUserId ");
//		stringBuilder.append(",T1.UPDATED_GROUP_ID updatedGroupId ");
//		stringBuilder.append("FROM CNT_CONTRACT T1 WHERE ");
//		if (null != obj.getStatus()) {
//			stringBuilder.append("T1.STATUS = :status ");
//		}
////		if (null != obj.getContractType()) {
//			stringBuilder.append("AND T1.CONTRACT_TYPE = 3 ");
////		}
//		if(StringUtils.isNotEmpty(obj.getKeySearch())){
//			stringBuilder.append("AND (UPPER(T1.NAME) like UPPER(:key) OR UPPER(T1.CODE) like UPPER(:key) escape '&')");
//		}
...
//
//		stringBuilder.append(" Where STATUS = 1 and contract_type=0  ");
//
//		if (StringUtils.isNotEmpty(criteria.getKeySearch())) {
//			stringBuilder
...
//		StringBuilder stringBuilder = getSelectQueryContract();
//
//		stringBuilder.append(" Where T1.STATUS = 1 and contract_type=3");
//		stringBuilder.append(obj.getIsSize() ? " AND ROWNUM <=10" : "");
//		if (StringUtils.isNotEmpty(obj.getKeySearch())) {
//			stringBuilder
//					.append(" AND (UPPER(T1.NAME) like UPPER(:key) OR UPPER(T1.CODE) like UPPER(:key) escape '&')");
...
//	public List<CntContractDTO> getForAuto(CntContractDTO obj) {
//		StringBuilder stringBuilder = getSelectAllQuery();
//
//		stringBuilder.append(" Where T1.STATUS=1");
//
