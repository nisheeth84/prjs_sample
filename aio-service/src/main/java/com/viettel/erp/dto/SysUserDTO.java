...
public class SysUserDTO extends BaseFWDTOImpl<SysUserBO> {
	...
	private Long sysGroupIdLv2;
	
	public Long getSysGroupIdLv2() {
		return sysGroupIdLv2;
	}

	public void setSysGroupIdLv2(Long sysGroupIdLv2) {
		this.sysGroupIdLv2 = sysGroupIdLv2;
	}
